...
| Оплата подписки | Telegram Payments / Stars |
...
|---|---|---|
| Бэкенд | Node.js + Vercel Functions | Уже используется, бесплатно |
| База данных | Supabase (PostgreSQL) | Бесплатный тир, простое подключение |
| Хранение фото | Cloudinary | Бесплатный тир, Telegram file → URL |
| Фронтенд | Уже готов (tg-app/) | Доработать под мультимастерность |
| Планировщик | Vercel Cron Jobs | Напоминания за 24ч и 2ч до визита |
